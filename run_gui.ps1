...
# --- Simulation Details ---
Write-Host "Running Forge GUI" -ForegroundColor Cyan
...
# --- Run Simulation ---
Write-Host "Navigating to forge-gui-desktop module to run..." -ForegroundColor Cyan
