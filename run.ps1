...
param(
    ...
    [string]$Deck1 = "_WOE PremierDraft_ _01 - WG.dck",

    [Parameter(Mandatory=$false)]
    [string]$Deck2 = "_WOE PremierDraft_ _02 - WG.dck",
...
$jvmArgs = "-Xms$Memory -XX:+UseParallelGC -Dsun.java2d.xrender=false --add-opens java.base/java.util=ALL-UNNAMED"
# Note: These JVM args are defined but not explicitly used in the mvn exec:java command below.
