...
public class HeadlessGui implements IGuiBase {
    ...
    @Override public String getCurrentVersion() { return "2.0.13-SNAPSHOT"; }
    ...
    @Override public <T> List<T> getChoices(String message, int min, int max, Collection<T> choices, Collection<T> selected, FSerializableFunction<T, String> display) { return (List<T>) selected; }
